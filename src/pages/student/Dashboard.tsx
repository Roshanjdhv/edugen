                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            {recentAnnouncements.length === 0 ? (
                                <p className="text-slate-500 text-sm italic col-span-3">No new announcements.</p>
                            ) : (
                        ...
                        {recentAnnouncements.length > 0 && (
                            <Link to="/student/classrooms" className="block text-center text-sm font-bold text-blue-600 hover:underline pt-4">
